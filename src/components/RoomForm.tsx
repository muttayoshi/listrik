    ...
    >
      ...
      <div className="relative z-10 w-full sm:max-w-sm bg-white dark:bg-emerald-950 rounded-t-3xl sm:rounded-3xl shadow-2xl">
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          {!room && (
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-500 mb-2 font-medium" style={{ fontFamily: 'var(--font-display)' }}>Preset ruangan</p>
          ...
          {/* Icon picker */}
          <div>
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 mb-2" style={{ fontFamily: 'var(--font-display)' }}>Ikon</p>
          ...
          {room && (
            delConfirm ? (
              <div className="flex gap-2">
                ...
                <button onClick={handleDelete} className="flex-1 py-3 rounded-2xl bg-red-500 dark:bg-red-600 text-white text-sm font-bold hover:bg-red-600 dark:hover:bg-red-500 transition-colors">Ya, Hapus Ruangan</button>
              </div>
            ) : (
